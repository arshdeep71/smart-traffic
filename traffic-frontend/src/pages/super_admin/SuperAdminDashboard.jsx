...
const SuperAdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    const s = connectSocket({ role: 'super_admin' });
  ...
  return (
    <div className="fade-in" style={{ maxWidth: '1200px', margin: '0 auto' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        <div>
          <h2 style={{ marginBottom: '0.3rem' }}>Super Admin Operations Hub</h2>
        ...
        <div className="glass-panel" style={{ padding: '2rem', height: '500px', display: 'flex', flexDirection: 'column' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
              <h3 style={{ margin: 0, display: 'flex', alignItems: 'center', gap: '0.8rem', letterSpacing: '1px' }}>
                <Radio size={24} color="#ea580c"/> SUPER-ADMIN: LIVE FLEET TRACKING
              </h3>
